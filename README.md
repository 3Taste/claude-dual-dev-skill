...
**Claude Code Skill** — 单机双 Agent 开发审查工作流。

在单台机器上同时运行**开发者 Agent + 审查者 Agent**：开发者 Agent 逐模块实现代码并提交，审查者 Agent 异步轮询每次提交、输出审查结论，基于信号文件驱动完整的开发→审查→合并循环。
...
```
dual-dev/
├── SKILL.md                              # skill 定义与 Q&A 流程（含清理流程）
├── README.md                             # 本文档
├── install.sh                            # 一键安装脚本
├── scripts/
